...
namespace Maps
{
    public class MapGenerator : MonoBehaviour
    {
        ...
        private static List<string> lineKeys = new List<string>
        {
            "highway"
        };
        ...
        public void GenerateMap()
        {
            ...
            mapHolder.AddComponent<MapFunctionality>().SetMapFunctionality(map.Bounds, buildings, areas, ways, mapBaseMaterial);
        ...
        void GenerateLines(Map map, Transform waysParent)
        {
            foreach (Way line in map.Lines)
            {
                ...
                if (build)
                {
                    GameObject go = BuildLine(map, line, "line", width * 3, 4, roadMaterial);
        ...
        void primeMaterials()
        {
            ...
            mapBaseMaterial = CreateMaterial(Shader.Find("Standard"), "_Color", mapBase, "MapBase");
